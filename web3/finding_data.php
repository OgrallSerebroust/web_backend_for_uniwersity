<?php
    ...
    if(($_POST["name"] != '') && ($_POST["email"] != '') && ($_POST["dirthday"] != 'Год') && (isset($_POST["sex"])) && (isset($_POST["foots"])) && (isset($_POST["perks"])) && (isset($_POST["biographi"])) && (isset($_POST["checking_verify"])) && (isset($_POST["confirm"])))
    {
