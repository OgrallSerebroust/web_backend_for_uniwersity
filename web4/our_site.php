        ...
        <form method="post" action="">
            <table width="50%" height="500">
                ...
                <tr>
                    ...
                    <td colspan="8">
                        <select class="selections_in_our_table" multiple size="3" name="perks[]">
                            ...
                            <option value="Passing" <?php if(strpos($values['perks'], "Passing,") == 1){print 'checked';}?>>Прохождение сквозь стены
                ...
                <tr>
                    ...
                    <td colspan="8">
                        <textarea id="biographi_are_in_table" name="biographi" placeholder="Главная информация о вас..." <?php if($errors['biographi']) {print 'class="error"';} ?>><?php print $values['perks'][0]; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <th>
